...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h4>Edit Somali Prosperity Leaders Profiles By ID:</h4></td>
</tr>
<tr>
...
$sql="select ID from leader where Party ='Somali' or Party ='ሶማሌ ' ORDER BY ID";
...
<center><h3> Update Somali Prosperity Leader Information</h3></center>
