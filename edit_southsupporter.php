...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit South Prosperity Party Supporter's Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from eprdf_supporter where eprdf_supporter ='SNNP' or eprdf_supporter ='ደቡብ' ORDER BY ID";
