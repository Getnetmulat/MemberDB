...
<div class="card-body">
              <div class="table-responsive">
                <table bgcolor="#3f879d" width="100%" cellspacing="0">
                  <thead>
 <tr>
...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h4>Edit South Prosperity Leaders Profiles By ID:</h4></td>
</tr>
<tr>
<td rowspan="3"><img src ='images/doc8.jpg' width ='90' height ='50'></td>
<td><label>Search Prosperity Leaders</label></td>
<td>
<?php
$conn = mysqli_connect(HOST,USER,PASSWORD,DATABASE);
$conn->query("SET NAMES 'utf8'");
$sql="select ID from leader where party in ('SNNPR','SNNPRS','SNNP','ደቡብ','ብልፅግና','South','ደቡብ ብልጽግና ርቲ','ብልፅግና ፓርቲ') || R_Zone ='ካፋ' ORDER BY ID";
...
<center><h3> Update South Prosperity Leader Information</h3></center>
...
{
if($ID==""||$fn==""||$mn==""||$ln==""||$sex==""||$age==""||$ed=="" ||$fs==""||$le==""||$ro==""||
	$wp==""||$Party==""||$my==""||$status=="" ||$Grade==""||$pr==""||$pz==""||$pw==""||
	$rr==""||$rz==""||$rw==""||$pw==""||$tc==""||$tt==""||
	$tr==""||$ty==""||$tg==""||$Amount=="")
{
	echo '<br>';
