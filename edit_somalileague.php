...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h3>Edit Somali Prosperity Party Leagues Profile By ID:</h3></td>
</tr>
<tr>
<td rowspan="3"><img src ='images/doc8.jpg' width ='90' height ='50'></td>
<td><label>Search Somali Prosperity Party Leagues</label></td>
<td>
<?php
$conn = mysqli_connect(HOST,USER,PASSWORD,DATABASE);
	 $conn->query("SET NAMES 'utf8'");
	 $sql="select ID from league where Party ='Somali' or Party ='ሶማሌ' ORDER BY ID";
