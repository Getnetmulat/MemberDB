...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Addis Ababa Prosperity Party members Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from member where Party in ('ቤንሻንጉል/ጉሙዝ','BG','Benshangul')  ORDER BY ID";
...
<td>ለተተኪ አመራር</td>
<td>
     <input type ="text"  name="Stock" value='<?php echo$user['Stock'];?>'>
...
$Photo = addslashes(file_get_contents($_FILES["Photo"]["tmp_name"]));
 ...
 $update="update member set 
       ...
       Sex='$sex',Age='$age',Phone_Number='$pn',Email ='$email',Leader_Experience='$ex',Education='$ed',file='$final_file',Field_Of_Study='$fs',
