...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h3>Edit Prosperity Party Leaders Profiles By ID:</h3></td>
</tr>
<tr>
...
$sql="select ID from leader where Party ='Amhara' or Party='አማራ' ORDER BY ID";
...
<center><h3> Update Amhara Prosperity Party Leader Information</h3></center>
	<tr><td>&nbsp;</td><tr>
...
{
if($ID==""||$fn==""||$mn==""||$ln==""||$sex==""||$age==""||$pn==""||$email==""||$ed=="" ||$fs==""||$le==""||$ro==""||
