...
echo"<font color=\"red\">Please enter All required fields Correctly!!</font>";
 echo "<font color=\"#fff\"><a href ='Add_Leader.php'><h4> Please Add Prosperity Party Leaders Carefully!!</h4></a>";
}
/*
...
if(move_uploaded_file($file_loc,$folder.$final_file))
 ...
 $sql = "INSERT INTO  leader(
      First_Name,Middle_Name,Last_Name,Sex,Age,Email,
Phone_Number,Education,file,Field_Of_Study,Expert_Experience,Leader_Experience,Resp_In_Gov,Resp_In_Org,Work_Place,Party,Membership_Year,Nation,status,Strength,Weakness,Grade,T_Grade,T_Center,T_Type,T_Year,T_Round,P_Region,P_Zone,P_Woreda,R_Region,R_Zone,R_Woreda,Amount,Photo) 
VALUES(  
'$fn','$mn','$ln','$sex','$age','$email','$pn','$ed','$final_file','$fs','$ee','$le','$rg','$ro','$wp','$Party','$my','$nation','$status','$Strength','$Weakness','$Grade','$tg','$tc','$tt','$ty','$tr','$pr','$pz','$pw','$rr','$rz','$rw','$Amount','$file')";
					
$sql1result=$conn->query($sql);
if($sql1result==1)
{
echo '<h3 align="center"><font color ="#08a372">Registered Successfully. Thanks!!'; echo '<br>';
echo '<a href ="display_leader.php"> <font color ="#120ba8"/>View the Registered Data. </a></h3>';
}
...
echo"<br>";
	  ...
	  $conn = mysqli_connect(HOST,USER,PASSWORD,DATABASE);
			...
			//header("Location: display_league.php");///?sorting=ASC&field=ID
   }
