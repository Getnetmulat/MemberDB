...
<p><span id ="header_logo">Welcome:[ <b><?php echo $_SESSION['username']; ?> ]&nbsp;&nbsp;&nbsp; 
           You are currently logged <?php echo $logged ?>.<a href="includes/logout.php">[Log Out!]</a>. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date("l").", ". date("M d") .", ". date("Y");?> </b> </p>
...
if (login_check($mysqli) == true) : 
	...
	$sql = "SELECT *
				FROM league where Party in('Somali','ሶማሌ')  
				ORDER BY $field $sort 
	...
	$sqlcount = "SELECT COUNT(ID) 
					AS numrows 
					FROM league where Party in('Somali','ሶማሌ')";// Find the number of rows in the query
	...
	echo "	<tr> 
				...
				<th nowrap width='5%'><a href='$phpself?sorting=$sort&field=ID &page=$pageNum'>መ/ቁ  </a></th>
				...
				<th nowrap width='15%'><a href='$phpself?sorting=$sort&field=Field_Of_Study&page=$pageNum'>የት/ት መስክ</a></th>
				
				<th nowrap width='25%'><a href='$phpself?sorting=$sort&field=Party&page=$pageNum'>ጽ/ቤት</a></th>
				<th nowrap width='15%'><a href='$phpself?sorting=$sort&field=Membership_Year&page=$pageNum'> የአባልነት ዘመን</a></th>
				<th nowrap width='8%'><a href='$phpself?sorting=$sort&field=Grade&page=$pageNum'>ደረጃ</a></th>
				<th nowrap width='15%'><a href='$phpself?sorting=$sort&field=file&page=$pageNum'> የት/ት መረጃ CV)</a></th>
