...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Somali Prosperity Party members Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from member where Party in ('Somali','ሶማሌ')  ORDER BY ID";
...
<center>
  ...
  <h4>Update Somali Prosperity Party members Information:</h4></center>
