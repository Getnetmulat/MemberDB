...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Sidama Prosperity Party Supporter's Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from eprdf_supporter where eprdf_supporter ='Sidama' or eprdf_supporter ='ሲዳማ' ORDER BY ID";
...
<center>
  ...
  <h5>Update South Prosperity Party Supporter's Information:</h5></center>
		<tr><td>&nbsp;</td></tr>
<tr>
<td>&nbsp;</td>
<td>መታወቂያ ቁጥር
