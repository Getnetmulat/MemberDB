...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Prosperity Party Leagues Profile By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from league ORDER BY ID";
...
$Photo = addslashes(file_get_contents($_FILES["Photo"]["tmp_name"]));
 ...
 $update="update league set 
          ...
          Phone_Number='$pn',Expert_Experience='$ee',Leader_Experience='$le',T_Center='$tc',T_Type='$tt',
