...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Prosperity Party members Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from member ORDER BY ID";
...
<center>
  ...
  box-shadow:0 0 1px #999;
   ...
   color:#058119;
 background: #8DC28D;">
  <h4>Update Prosperity Party members Information:</h4></legend></td></tr></center>
	<tr><tr>
 </tr></tr>
<tr>
<td>&nbsp;</td>
...
<tr><td>&nbsp;</td>
<td>ለአመራርነት የተመለመሉ አባላት</td>
<td><input type="text"  name="Stock" value='<?php echo$user['Stock'];?>' /></td>
...
{
if($ID==""||$fn==""||$mn==""||$ln==""||$sex==""||$age==""||$pn==""||$email==""||$ed=="" 
||$fs==""||$ex==""||$rg==""||$ro==""||$wp==""||$Party==""||$my==""||$status=="" ||$Strength==""
