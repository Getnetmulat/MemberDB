...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Oromia Prosperity Party members Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from member where Party in ('Oromia','ኦሮሚያ')  ORDER BY ID";
