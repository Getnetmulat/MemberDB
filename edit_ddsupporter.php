...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h5>Edit Dire Dawa Prosperity Party Supporter's Profiles By ID:</h5></td>
</tr>
<tr>
...
$sql="select ID from eprdf_supporter where eprdf_supporter ='DD' or eprdf_supporter ='ድሬዳዋ' ORDER BY ID";
