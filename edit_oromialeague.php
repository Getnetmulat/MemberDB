...
<tr> 
	<td>&nbsp;</td>
	 <td height="29" colspan="3" align="center"><h3>Edit South Prosperity Party Leagues Profile By ID:</h3></td>
</tr>
<tr>
<td rowspan="3"><img src ='images/doc8.jpg' width ='90' height ='50'></td>
<td><label>Search South Prosperity Party Leagues</label></td>
<td>
<?php
$conn = mysqli_connect(HOST,USER,PASSWORD,DATABASE);
	 $conn->query("SET NAMES 'utf8'");
	 $sql="select ID from league where Party ='Oromia' or Party ='ኦሮሚያ' ORDER BY ID";
